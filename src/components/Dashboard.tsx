import { useEffect, useState, type ReactNode } from 'react'; 
 ...
 import { type View } from '../App'; // <-- Importar el tipo View 
 
 // Aceptar la prop setCurrentView 
 ...
 function QuickAction({ text, onClick }: { text: string; onClick: () => void }) { 
   return ( 
     <button 
       onClick={onClick} 
       className="w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 rounded-lg transition-colors border border-gray-200" 
     > 
       {text} 
     </button> 
   ); 
